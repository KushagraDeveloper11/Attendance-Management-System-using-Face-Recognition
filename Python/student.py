...
class Student:
    def __init__(self, root):
        ...
        img_left= img_left.resize((620,100), Image.LANCZOS)
        self.photoimg_left= ImageTk.PhotoImage(img_left)
      
        f_label= Label(Left_frame, image= self.photoimg_left)
        f_label.place(x=0, y=0, width=620, height= 150)


        # current course information
        current_course_frame=LabelFrame(Left_frame,bd=2,bg="white",relief=RIDGE,text="Current course information",font=("times new roman",12,"bold"))
        current_course_frame.place(x=0,y=135,width=650,height=150)
        ...
        class_student_frame.place(x=0,y=200,width=650,height=350)
        ...
        # Radio Buttons
        radionbt1=ttk.Radiobutton(class_student_frame,textvariable=self.var_radio1, text="Take Photo Sample",value="Yes")
        radionbt1.grid(row=6,column=0)

        radionbt2=ttk.Radiobutton(class_student_frame, textvariable=self.var_radio2, text="No Photo Sample",value="No")
        radionbt2.grid(row=6,column=1)

        # button frame
        btn_frame=Frame(class_student_frame,bd=2,relief=RIDGE,bg="White")
        btn_frame.place(x=0,y=100,width=650,height=35)
        ...
        btn_frame=Frame(class_student_frame,bd=2,relief=RIDGE,bg="White")
        btn_frame.place(x=0,y=175,width=650,height=35)
        ...
        Right_frame.place(x=670,y=0,width=600,height=600)


        img_right= Image.open(r"Python\Images\background.jpg")
        img_right= img_right.resize((620,100), Image.LANCZOS)
        self.photoimg_left= ImageTk.PhotoImage(img_right)
      
        f_label= Label(Right_frame, image= self.photoimg_left)
        f_label.place(x=5, y=0, width=600, height= 100)


        # ============= Search System===============

        Search_frame=LabelFrame(Right_frame,bd=2,bg="white",relief=RIDGE,text="Search System",font=("times new roman",12,"bold"))
        Search_frame.place(x=0,y=135,width=600,height=70)
        ...
        table_frame.place(x=5,y=210,width=600,height=50)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            # messagebox.showinfo("Sucess","Welcome to our apps")
            conn= mysql.connector.connect(host= "localhost", username="root", password="123", database="face_recognizer")
